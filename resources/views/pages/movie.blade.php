                        ...
                        <div class="movie_info col-xs-12">
                            ...
                            <div class="film-poster col-md-9">
                                ...
                                <ul class="list-info-group">
                                    ...
                                    <li class="list-info-group-item">
                                        <span>Quốc gia</span> :
                                        <a href="{{ route('genre', $movie->country->slug) }}"
                                            rel="category tag">{{ $movie->country->title }}</a>
                                    <li class="list-info-group-item">
                                        <span>Danh mục</span> :
                                        <a href="{{ route('genre', $movie->category->slug) }}"
                    ...
                    <div class="entry-content htmlwrap clearfix">
                        <div class="video-item halim-entry-box">
                            <article id="post-38424" class="item-content">
                                Phim <a href="{{ route('movie', $movie->slug) }}">{{ $movie->title }}</a> - 2021 - Mỹ:
                                <p>
                                    {{ $movie->description }}
                                </p>
                            </article>
