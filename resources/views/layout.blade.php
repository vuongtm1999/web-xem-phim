...
<html lang="vi">
   <head>
      ...
      <title>Phim hay 2023 - Web xem phim cua Vuong</title>
      <meta name="description" content="Phim hay 2023 - Web xem phim cua Vuong, xem phim online miễn phí, phim hot , phim nhanh" />
               ...
               <div class="collapse navbar-collapse" id="halim">
                  <div class="menu-menu_1-container">
                     <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                        ...
                        <li><a title="Phim Lẻ" href="{{ route("movie") }}">Phim Lẻ</a></li>
                        <li><a title="Phim Bộ" href="{{ route("watch") }}">Phim Bộ</a></li>
