...
<head>
    ...
    <meta name="description"
        content="Phim hay 2023 - Web xem phim cua Vuong, xem phim online miễn phí, phim hot , phim nhanh" />
                            ...
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($genre as $cate)
                                        <li><a title="{{ $cate->title }}"
                                                href="{{ route('genre', $cate->slug) }}">{{ $cate->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="mega dropdown">
                                ...
                                <ul role="menu" class=" dropdown-menu">
                                    @foreach ($country as $item)
                                        <li><a title="{{ $item->title }}"
                                                href="{{ route('country', $item->slug) }}">{{ $item->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                        </ul>
